<?php
  ...
  $queryAllProblems="SELECT * from problem where is_posted='p'";
...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        ...
        <div class="navbar-collapse collapse">
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="pendingproblem.php">Pending</a></li>
    ...
    <div class="container">
      ...
      <a href="addproblem.php" ><button class="btn btn-primary btn-lg">Add Judge File</button></a>
      </div>
